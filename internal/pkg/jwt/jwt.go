...
func GenerateAccessToken(uid uint, name, appCode string, groups []string) (string, error) {
	claims := &AccessToken{
		UserToken: UserToken{
...
func GenerateRefreshToken(uid uint, name, appCode string, groups []string) (string, error) {
	claims := &RefreshToken{
		UserToken: UserToken{
