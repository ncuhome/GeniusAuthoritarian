...
func (a FeishuGroupsSrv) GetAll(opts ...daoUtil.ServiceOpt) ([]dao.FeishuGroupModel, error) {
	return (&dao.FeishuGroups{}).GetAll(daoUtil.TxOpts(a.DB, opts...))
}

func (a FeishuGroupsSrv) GetByOpenID(openID []string, opts ...daoUtil.ServiceOpt) ([]dao.FeishuGroupModel, error) {
...
func (a FeishuGroupsSrv) CreateAll(data []dao.FeishuGroupModel) error {
